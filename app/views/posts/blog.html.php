...
<a href="<?= ROOT_URL . "/posts/add/" ?>" class="btn btn-primary">New Blog</a>
          ...
          <div class="blog-entry align-self-stretch">
            ...
            <div class="text mt-3 d-block">
              ...
              <div class="meta mb-3">
                ...
                <div><a href="#" class="meta-chat"><span class="icon-chat"></span> 2</a></div><br>
                <?php if (isset($_SESSION['is_logged_in'])) : ?>
                  <div><a href="<?= ROOT_URL . "/posts/delete/" . $item['id'] ?>">Delete</a></div>
                  <div><a href="<?= ROOT_URL . "/posts/edit/" . $item['id'] ?>">Edit</a></div>
                <?php endif; ?>
              </div>
            </div>
          </div>
